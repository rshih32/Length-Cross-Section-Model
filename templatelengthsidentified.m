function [ lengthtemplate, strokeidentifier ] = templatelengthsidentified( orderedlengthtemplate, strokerelation )
        ...
        for j=1:coldim
            ...
            if(orderedlengthtemplate(i,j,rotation) > 0)
                ...
                elseif(mode == 1)
                    ...
                    currentclass = strokerelation(strokeidentifier(i,lengthtemplatecol, rotation));
                    replacement = strokerelation(orderedlengthtemplate(i,j,rotation));
                    ...
                    if(currentclass~=0 && replacement == 0)
                        strokeidentifier(i,lengthtemplatecol, rotation)=orderedlengthtemplate(i,j,rotation);
                    elseif(currentclass~= 0 && currentclass~= 1 && replacement == 1)
                        strokeidentifier(i,lengthtemplatecol, rotation)=orderedlengthtemplate(i,j,rotation);
                    elseif(currentclass==2 && replacement == -1)
                        strokeidentifier(i,lengthtemplatecol, rotation)=orderedlengthtemplate(i,j,rotation);
                    end
                end
            else
